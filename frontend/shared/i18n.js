...
window.PerthI18n = (function () {
  ...
  const STR = {
    pt: {
      ...
      "deletes the board, its history and its chat — forever": "exclui o quadro, seu histórico e seu chat — para sempre",
      "Delete the board": "Excluir o quadro",
      "Its cards, its history and its chat go with it. This cannot be undone.": "Os cards, o histórico e o chat vão junto. Não dá para desfazer.",
      "Deleting one is permanent, and the board in use cannot be deleted.": "Excluir é definitivo, e o quadro em uso não pode ser excluído.",
      ...
      "Only the host machine can switch, create or delete boards.": "Só a máquina anfitriã pode trocar, criar ou excluir quadros.",
      ...
      "Linked file not loaded — the board kept its last good version": "O arquivo vinculado não foi carregado — o board manteve a última versão boa",
      "Chat": "Chat",
      "Close (Esc)": "Fechar (Esc)",
    ...
    es: {
      ...
      "deletes the board, its history and its chat — forever": "elimina el tablero, su historial y su chat — para siempre",
      "Delete the board": "Eliminar el tablero",
      "Its cards, its history and its chat go with it. This cannot be undone.": "Sus tarjetas, su historial y su chat se van con él. No se puede deshacer.",
      "Deleting one is permanent, and the board in use cannot be deleted.": "Eliminar es definitivo, y el tablero en uso no se puede eliminar.",
      ...
      "Only the host machine can switch, create or delete boards.": "Solo la máquina anfitriona puede cambiar, crear o eliminar tableros.",
      ...
      "Linked file not loaded — the board kept its last good version": "No se cargó el archivo vinculado — el tablero conservó su última versión buena",
      "Chat": "Chat",
      "Close (Esc)": "Cerrar (Esc)",
      "Send (Enter)": "Enviar (Enter)",
    ...
    fr: {
      ...
      "deletes the board, its history and its chat — forever": "supprime le tableau, son historique et son chat — définitivement",
      "Delete the board": "Supprimer le tableau",
      "Its cards, its history and its chat go with it. This cannot be undone.": "Ses cartes, son historique et son chat partent avec lui. Irréversible.",
      "Deleting one is permanent, and the board in use cannot be deleted.": "La suppression est définitive, et le tableau en cours ne peut pas être supprimé.",
      ...
      "Only the host machine can switch, create or delete boards.": "Seule la machine hôte peut changer, créer ou supprimer des tableaux.",
      ...
      "Linked file not loaded — the board kept its last good version": "Fichier lié non chargé — le tableau a gardé sa dernière version valide",
      "Chat": "Discussion",
      "Close (Esc)": "Fermer (Échap)",
    ...
    zh: {
      ...
      "deletes the board, its history and its chat — forever": "删除该看板及其历史和聊天记录 —— 永久删除",
      "Delete the board": "删除看板",
      "Its cards, its history and its chat go with it. This cannot be undone.": "它的卡片、历史和聊天记录会一并消失。此操作无法撤销。",
      "Deleting one is permanent, and the board in use cannot be deleted.": "删除是永久性的，正在使用的看板不能删除。",
      "no subfolders": "无子文件夹",
      ...
      "Only the host machine can switch, create or delete boards.": "只有主机才能切换、创建或删除看板。",
      ...
      "Linked file not loaded — the board kept its last good version": "未加载关联文件 — 看板保留了上一个有效版本",
      "Chat": "聊天",
      "Close (Esc)": "关闭 (Esc)",
      "Send (Enter)": "发送 (回车)",
