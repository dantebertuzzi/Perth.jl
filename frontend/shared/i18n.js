...
window.PerthI18n = (function () {
  ...
  const STR = {
    pt: {
      ...
      "e.g. Paulo": "ex.: Paulo",
      "could not load share info": "não deu para carregar os dados de transmissão",
    ...
    es: {
      ...
      "could not load share info": "no se pudieron cargar los datos de transmisión",
    ...
    fr: {
      ...
      "could not load share info": "impossible de charger les infos de diffusion",
    ...
    zh: {
      ...
      "e.g. Paulo": "例如：Paulo",
      "could not load share info": "无法加载共享信息",
